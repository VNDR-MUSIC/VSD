...
import { Wifi, Signal, ServerCrash, Clock, View } from 'lucide-react';

export const metadata: Metadata = {
  title: 'Network Status | VSD Bank',
  description: 'Live status overview of all connected services and API endpoints integrated with the VSD Network.',
};

// --- Mock Data ---
// In a real application, this data would be fetched from a monitoring service,
// health check endpoints, or a Firestore collection updated by a backend process.
