...
export const metadata: Metadata = {
  ...
  description: 'API documentation for integrating with VSD Network services, such as the AI Image Generation API.',
};
    ...
    <div className="space-y-12 sm:space-y-16 py-8">
      <header className="text-center">
        ...
        <p className="text-base sm:text-lg lg:text-xl text-muted-foreground max-w-3xl mx-auto">
          Integrate VSD Network's AI capabilities into your own applications.
        </p>
      </header>
      ...
      <Card className="shadow-lg bg-card/80 backdrop-blur-sm">
        <CardHeader>
            <div className="flex items-center space-x-3 mb-2">
                ...
                <CardTitle className="font-headline text-2xl sm:text-3xl">AI Image Generation API</CardTitle>
            </div>
            <CardDescription className="text-base sm:text-lg">
                This endpoint allows you to generate images by providing a textual hint, leveraging the same "IMG Services" available on the VSD Network.
            </CardDescription>
        </CardHeader>
        <CardContent className="prose prose-sm sm:prose-base prose-invert max-w-none">
            ...
            <p>Authentication is handled via a Bearer token in the `Authorization` header. You must provide your secret API key.</p>
            <div className="flex items-center gap-2 p-4 my-4 rounded-md border border-amber-500/50 bg-amber-500/10">
                ...
                <p className="text-sm text-amber-200">
                    <strong>Important:</strong> Keep your API key secure and do not expose it in client-side code. This key should be stored as a server-side environment variable.
                </p>
            </div>
            <CodeBlock>
...
// Example: Internal Server Error (500)
{
  "error": "An internal server error occurred."
            ...
            <p>Here is an example of how to call the API using `curl` from your terminal.</p>
            <CodeBlock>
