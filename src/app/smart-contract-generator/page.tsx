...
//   description: 'Generate foundational smart contracts with AI and get free deployment assistance from VSD Network.',
// };
...
export default function SmartContractGeneratorPage() {
  ...
  const handleGenerateContract = async (data: ContractFormData) => {
    ...
    try {
      ...
      if (parsedResult.success) {
        setGeneratedContract(parsedResult.data);
         toast({
          ...
          description: "Your smart contract has been successfully generated by AI.",
        });
      } else {
         setError("AI returned an unexpected data structure. Please review the console and try again.");
         console.error("AI response parsing error:", parsedResult.error.flatten());
         toast({
            title: "AI Response Error",
            description: "The AI returned data in an unexpected format. See console for details.",
            variant: "destructive",
         });
      }
    } catch (e) {
      ...
      setError(`An error occurred while generating the smart contract: ${errorMessage}`);
      toast({
        title: "Generation Failed",
        description: `Failed to generate contract: ${errorMessage}`,
        variant: "destructive",
      });
    }
    setIsLoading(false);
    ...
    <div className="container mx-auto px-4 md:px-6 py-12">
      ...
      <div className="grid lg:grid-cols-2 gap-12">
        ...
        <Card className="shadow-xl">
          <CardHeader>
            <CardTitle className="font-headline text-2xl">1. Describe Your Smart Contract</CardTitle>
            ...
            <form onSubmit={contractForm.handleSubmit(handleGenerateContract)} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input id="platform" {...contractForm.register("platform")} defaultValue="Ethereum" placeholder="e.g., Ethereum, Polygon" />
                </div>
              </div>
              <Button type="submit" disabled={isLoading} className="w-full btn-hover-effect py-6 text-base">
        ...
        <div className="space-y-8">
          <Card className="shadow-xl">
            <CardHeader>
              <CardTitle className="font-headline text-2xl">2. AI-Generated Smart Contract</CardTitle>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-2">
                      <Label htmlFor="solidityCodeOutput" className="text-lg">Solidity Code:</Label>
                      <Button variant="outline" size="sm" onClick={() => copyToClipboard(generatedContract.solidityCode)}>
                        <Copy className="mr-2 h-4 w-4" /> Copy Code
                      </Button>
                    </div>
                    <pre id="solidityCodeOutput" className="language-solidity overflow-x-auto rounded-md bg-card p-4 text-sm text-card-foreground max-h-[30rem] border">
          ...
          <Card className="bg-gradient-to-br from-primary/10 via-background to-background shadow-xl border-primary/20">
            <CardHeader>
              <CardTitle className="font-headline text-2xl">3. Deploy with VSD Network - <span className="text-primary opacity-80 line-through">Standard Pricing</span> FREE!</CardTitle>
              <CardDescription>
                Let our experts handle the deployment and ongoing support. This is a limited-time promotional offer.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="p-4 border border-dashed border-primary/50 rounded-lg bg-card/50">
                <h3 className="font-semibold text-lg mb-2 text-primary/90">Standard Deployment Service Includes:</h3>
                <ul className="list-disc list-inside text-muted-foreground space-y-1 text-sm">
                  <li>Expert consultation and code review</li>
                  <li>Secure deployment to your chosen network</li>
                  <li>Initial setup and configuration</li>
                  <li>Basic post-deployment support</li>
                </ul>
                <p className="mt-3 font-bold text-primary text-lg">
                  LIMITED TIME OFFER: All above services are completely FREE!
                </p>
                <p className="text-xs text-muted-foreground mt-1">
                  Build value with VSD. This offer is to help kickstart your project on the VSD ecosystem. Terms and conditions may apply for extended support.
                </p>
              </div>
              ...
              <form onSubmit={registrationForm.handleSubmit(handleRegistrationSubmit)} className="space-y-4">
                ...
                <Button type="submit" className="w-full btn-hover-effect py-6 text-base">
                  <UserPlus className="mr-2 h-5 w-5" />
                  Claim Your Free Deployment
                </Button>
              </form>
            </CardContent>
          </Card>
