...
import {
  ...
  generateVsdSmartContract,
} from '@/ai/flows/generate-smart-contract-flow';
import { Form, FormControl, FormDescription, FormField, FormItem, FormLabel, FormMessage } from '@/components/ui/form';

// export const metadata: Metadata = { // Metadata should be exported from Server Components or layout files
//   title: 'AI Smart Contract Generator | VSD Network',
//   description: 'Generate an example Solidity smart contract for integrating VSD into your business.',
// };
...
export default function SmartContractGeneratorPage() {
  ...
  const onSubmit: SubmitHandler<GenerateSmartContractInput> = async (data) => {
    ...
    setError(null);
    try {
      const response = await generateVsdSmartContract(data);
      setResult(response);
      if (response.solidityCode.startsWith('// An error occurred')) {
         setError("Failed to generate contract. Please check the provided details or try again.");
      }
    } catch (e) {
    ...
    <div className="space-y-12 py-8">
      <header className="text-center">
        ...
        <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto">
          Describe your business needs for VSD integration, and our AI will generate an example Solidity smart contract to get you started.
        </p>
         <Card className="mt-6 max-w-2xl mx-auto bg-destructive/10 border-destructive/30 text-destructive-foreground">
          ...
          <CardContent className="text-sm text-destructive/90 text-left">
            The smart contract code generated by this tool is for **illustrative and educational purposes ONLY**.
      ...
      {error && !result?.solidityCode.startsWith('// An error occurred') && (
            ...
            <div className="flex justify-between items-center">
              <div>
                <CardTitle className="font-headline text-2xl flex items-center">
                  <Code2 className="mr-2 h-6 w-6 text-primary" /> Generated Solidity Code
                </CardTitle>
                <CardDescription>Below is the example smart contract generated by the AI.</CardDescription>
              </div>
              <Button variant="outline" size="sm" onClick={() => copyToClipboard(result.solidityCode, 'Code')}>
